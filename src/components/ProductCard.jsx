        ...
        <div>
            <div className='relative group cursor-pointer'>
                ...
                <div className=" absolute bottom-full left-0 right-0 bg-black/50 overflow-hidden w-full h-0 transition-all !duration-500 group-hover:bottom-0 group-hover:h-full justify-center items-center hidden md:flex">
                    <Link href='' className="bg-[#000] text-white text-center w-[80%] inline-block bg-transparent text-[16px] border-[1px] border-solid border-[#fff] py-2 px-5 hover:bg-[#fff] hover:text-[#000] font-semibold">XEM THÊM</Link>
                </div>
            </div>
